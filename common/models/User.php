...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function getUsersByRole($roleName)
    {
        ...
        $command = $connection->createCommand(
            "SELECT * FROM rbac_auth_assignment INNER JOIN public.user ON rbac_auth_assignment.user_id::int = public.user.id " .
            "WHERE rbac_auth_assignment.item_name = '" . $roleName . "';");
