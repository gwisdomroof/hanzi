                    ...
                    'items'=>[
                        ...
                        [
                            ...
                            'items'=>[
                                ...
                                ['label'=>Yii::t('backend', 'Comments'), 'url'=>['/comment/manage/index'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
                            ]
                        ],
                        [
                        ...
                        [
                            ...
                            'items'=>[
                                ...
                                ['label'=>Yii::t('backend', 'RBAC Admin'), 'url'=>['/admin'], 'icon'=>'<i class="fa fa-angle-double-right"></i>'],
