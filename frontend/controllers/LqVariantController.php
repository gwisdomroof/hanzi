...
class LqVariantController extends Controller
{
    ...
    public function actionImport()
    {
        ...
        foreach ($models as $model) {
            ...
            $time = time();
            $sqls[] = "INSERT INTO lq_variant(source, ori_pic_name, word, pic_name, belong_standard_word_code, nor_var_type, created_at, updated_at) VALUES ({$source}, '{$model->pic_name}', '{$word}', '{$pic_name}', '{$model->belong_standard_word_code}', {$type}, {$time}, {$time});";
