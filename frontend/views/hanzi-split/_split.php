...
?>
    ...
    <div class="hanzi-form col-sm-7">
        ...
        <?php if ($seq == 2) {
            ...
            <?php echo $form->field($model, 'hard20')->radioList(['0' => '否', '1' => '是'], [
                'item' => function ($index, $label, $name, $checked, $value) {
                    return '<label class="radio-inline">' . Html::radio($name, $checked, ['value' => $value]) . $label . '</label>';
                }]); ?>
            ...
            <?php echo Html::activeHiddenInput($model, 'split20_completed', ['value' => 1]) ?>
        ...
        <?php if ($seq == 3) {
            ...
            <?php echo Html::activeHiddenInput($model, 'split30_completed', ['value' => 1]) ?>
