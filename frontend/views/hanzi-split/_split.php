...
<div class="hanzi-form">
    ...
    <?php echo $form->field($model, 'duplicate10')->textInput(['maxlength' => true, 'readonly' => $readonly, 'placeholder' => '填写与上面字头重复的文字。若有重复，则不须进行后面的拆分。']) ?>
    ...
    <?php if($seq == 2) { 
        ...
        ?>
    <?php echo $form->field($model, 'duplicate20')->textInput(['maxlength' => true, 'readonly' => $readonly, 'placeholder' => '填写与上面字头重复的文字。若已重复，则不须拆分。']) ?>
    ...
    <?php echo $form->field($model, 'duplicate30')->textInput(['maxlength' => true, 'readonly' => $readonly, 'placeholder' => '填写与上面字头重复的文字。若已重复，则不须拆分。']) ?>
