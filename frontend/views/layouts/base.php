...
<div class="wrap">
    ...
    <?php echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => Yii::t('frontend', '部件笔画检字法'), 'url' => ['/hanzi-set/bsearch'],'visible'=>!Yii::$app->user->isGuest,],
            ['label' => Yii::t('frontend', '异体字检索'), 'url' => ['/hanzi-set/ysearch'],'visible'=>!Yii::$app->user->isGuest,],
