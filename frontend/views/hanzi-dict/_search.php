...
<div class="search-result">
    ...
    <div><a target="_blank" href=<?=Url::toRoute(['hanzi-dict/variant', 'param' => $param, 'a' => 'hy'])?>><?php
    ...
    <div><a target="_blank" href=<?=Url::toRoute(['hanzi-dict/variant', 'param' => $param, 'a' => 'dh'])?>><?php
